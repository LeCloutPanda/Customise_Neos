...
$NeosProc = Start-Process -FilePath $NeosExe -WorkingDirectory $NeosDir -ArgumentList "-Invisible", "-screen-width 1920", "-screen-height 1080", "-DontAutoOpenCloudHome", "-SkipIntroTutorial", "-Screen", "-LoadAssembly `"D:\Games\Neos\app\Libraries\NeosModLoader.dll`"" -passthru
